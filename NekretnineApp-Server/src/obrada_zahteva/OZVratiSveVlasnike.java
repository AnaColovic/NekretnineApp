 ...
 */
public class OZVratiSveVlasnike implements IOBradaZahteva {

    @Override
    public OdgovorServera izvrsi(Object podaci) throws Exception {
        OdgovorServera odgovor = new OdgovorServera();
        List<OpstaDomenskaKlasa> vlasnici = Kontroler.getInstance().vratiSveVlasnike();

        odgovor.setPodaci(vlasnici);
